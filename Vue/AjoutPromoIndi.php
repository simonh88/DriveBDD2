...
class AjoutPromoIndi extends AdminHomeVue {
    ...
    public function displayBody() {
        ...
        <form method="post" action="drive.php?acces=Admin&a=AjoutPromoIndi">
            ...
            <div class="form-inline">
                ...
                <div class="radio">
                    <label><input type="radio" name="radio" value="absolue" required=""> € </label>
                </div>
                <div class="radio">
                    <label class=""><input type="radio" name="radio" value="relatif"> % </label>
                </div>
